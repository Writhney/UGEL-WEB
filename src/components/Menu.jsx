...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  const windowClick = ( ) => {
    ...
    const headerNavSubListRow1 = document.getElementById('headerNavSubListRow');
    const headerNavSubList1 = document.getElementById('headerNavSubList');
    let contador = 1;
